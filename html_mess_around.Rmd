...
<!--         <button  -->
<!--           type="button"  -->
<!--           class="my-1 rounded btn"  -->
<!--           style="background-color: #f5e9dd;  -->
<!--             color: black; -->
<!--             border-color: black;"> -->
<!--               $b1$ -->
<!--           </button> -->
...
<!-- class="list-group-item list-group-item-action my-1 rounded btn btn-outline-dark mb-2" -->
<!-- first thing adds padding -->
<!-- second thing makes it the width of the row -->
<!-- btn makes the shadow hug the button -->
<!-- btn-outline-dark makes whatever colore your outline is darker -->
          
<!-- <a href=$links.url$> -->
<!--         <button  -->
<!--           type="button"  -->
<!--           class="my-1 rounded btn btn-outline-dark mb-2"  -->
<!--           style="background-color: #f5e9dd;  -->
<!--             color: black; -->
<!--             border-color: black;"> -->
<!--               $b2$ -->
